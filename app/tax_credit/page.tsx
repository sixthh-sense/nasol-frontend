        ...
        const fetchFutureAssets = async () => {
            try {
                ...
                const response = await fetch(
                    `${process.env.NEXT_PUBLIC_API_BASE_URL}/documents-multi-agents/tax-credit`,
                    {
                        credentials: "include",
                    }
                );
        ...
        return (
            <div className="flex justify-center items-center h-screen bg-zinc-50 dark:bg-black">
                <div className="text-center">
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400">세액 공제 가능 항목 분석 중...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-6">
                        <h1 className="text-3xl font-bold text-white">세액 공제 가능 항목 확인</h1>
                        <p className="text-blue-100 mt-2">세액 공제 가능 항목을 확인하고 절세로 부자가 되자!</p>
                    </div>
